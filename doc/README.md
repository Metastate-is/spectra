...
## Цели проекта
- Обеспечить гибкую платформу для интеграции с внешними сервисами (REST, gRPC, Redis, Neo4j, EVM).
...
- **Internal REST** — синхронные команды и уведомления между сервисами.
...
src/                 # Исходный код приложения
  core/              # Базовые сервисы (логгер, кэш, телеметрия, internal REST, Redis, Neo4j)
...
- Основные параметры: подключения к БД, internal REST, Redis, gRPC, параметры смарт-контрактов.
